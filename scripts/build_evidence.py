...
LINE_START_ACTIONS = {}
MOVES = [
    ('the_whole_column_of_rows_cascading', 1, 0.35),
    ('the_dashed_baseline_crawling_while_the', 2, 0.35),
    ('the_counter_hitting_its_stop_and', 3, 0.35),
    ('the_crane_descending_past_the_treeline', 4, 0.35),
    ('the_bar_rising_to_its_stop', 5, 0.35),
    ('the_head_tilting_up', 6, 0.35),
    ('the_shear_landing_and_the_tip', 7, 0.35),
    ('the_dashed_baseline_crawling', 8, 0.35),
    ('the_pullback_revealing_relative_size', 9, 0.35),
    ('the_stamp_hanging_unlanded', 10, 0.35),
    ('the_walking_figure', 11, 0.35),
    ('the_jets_crossing', 12, 0.35),
    ('the_contrail_flattening_to_a_line', 13, 0.35),
    ('the_words_typing_in', 14, 0.35),
    ('the_two_lists_building', 15, 0.35),
    ('the_chip_sliding_toward_the_lease', 16, 0.35),
    ('the_plate_rising', 17, 0.35),
    ('her_two_fingers_pushing_the_land', 18, 0.35),
    ('the_raking_key_travelling_along_the', 19, 0.35),
    ('the_figure_walking_into_the_widening', 20, 0.35),
    ('the_plate_rising_under_the_figure', 21, 0.35),
    ('the_card_unfolding_into_the_stack', 22, 0.35),
    ('the_two_halves_shoving_apart', 23, 0.35),
    ('the_share_bars_standing_up_over', 24, 0.35),
    ('the_shares_compressing_together', 25, 0.35),
    ('the_fuel_half_straining_up', 26, 0.35),
    ('the_generation_block_slotting_in', 27, 0.35),
    ('the_fuel_half_climbing', 28, 0.35),
    ('the_half_reaching_for_the_empty', 29, 0.35),
    ('windows_coming_on_street_by_street', 30, 0.35),
    ('the_two_silhouettes_settling_onto_the', 31, 0.35),
    ('the_crate_opening', 32, 0.35),
    ('the_empty_plate_tipping', 33, 0.35),
    ('the_plate_rim_grinding_round_as', 34, 0.35),
    ('the_hand_coming_down_and_the', 35, 0.35),
    ('the_hand_settling_on_the_solid', 36, 0.35),
    ('the_two_tokens_swapping_order', 37, 0.35),
    ('the_pen_hovering_never_landing', 38, 0.35),
    ('the_row_lifting_and_holding', 39, 0.35),
]
