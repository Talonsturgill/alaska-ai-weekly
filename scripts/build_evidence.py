...
MOVE_RUN_DATE = "2026-09-12"
LINE_START_ACTIONS = {}
MOVES = [
    ("notebook_opens", 1, 0.35),
    ("public_page_yields", 2, 0.35),
    ("next_step_catches", 3, 0.35),
    ("lab_bench_assembles", 4, 0.35),
    ("dry_sensor_seats", 5, 0.35),
    ("announcement_files", 6, 0.35),
    ("lab_name_seats", 7, 0.35),
    ...
    ("public_recording_selects", 14, 0.35),
    ("own_task_plan_arrives", 15, 0.35),
    ("concealed_wing_hints", 16, 0.35),
    ("participant_waiting_arrival", 17, 0.35),
    ("reading_plan_unfolds", 18, 0.35),
    ("cognitive_target_attaches", 19, 0.35),
    ("programming_plan_unfolds", 20, 0.35),
    ("eye_movement_separates", 21, 0.35),
    ("planned_answers_stay_open", 22, 0.35),
    ("archive_reveals", 23, 0.35),
    ("task_a_matches", 24, 0.35),
    ("task_a_analysis_runs", 25, 0.35),
    ("task_b_question_arrives", 26, 0.35),
    ("inventory_assessment", 27, 0.35),
    ("optional_collection_choice", 28, 0.35),
    ("extra_wing_reveals", 29, 0.35),
    ("courtesy_callback", 30, 0.35),
    ("task_plan_attaches", 31, 0.35),
    ("interpretation_separates", 32, 0.35),
    ("conditional_claim_opens", 33, 0.35),
    ("heldout_person_enters_test", 34, 0.35),
    ("evaluation_page_opens", 35, 0.35),
    ("methods_pocket_folds", 36, 0.35),
    ("uaa_plans_return", 37, 0.35),
    ("pencil_poises", 38, 0.35),
    ("notebook_loops", 39, 0.35),
]
