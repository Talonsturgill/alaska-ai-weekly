...
MOVES = [
    # RE-ANCHORED 2026-09-01 for "The Ceiling Was in the Measurement" against
    # the selected Gemini take. One strip per consequential visual move.
    ("ceiling_slam", 0, 0.35),
    ("ribbon_hook", 0, 2.80),
    ("author_card", 1, 1.80),
    ("uaf_credit", 1, 4.90),
    ("wind_deploy", 2, 0.60),
    ("l1_distance", 2, 4.50),
    ("paired_minutes", 3, 1.40),
    ("signal_changes_corridor", 3, 3.88),
    ("match_grid", 3, 5.50),
    ("full_pairing_field", 3, 7.58),
    ("uncertainty_fray", 4, 0.80),
    ("mismatch_shift", 5, 2.40),
    ("simulated_curve", 6, 1.60),
    ("calibration", 7, 1.00),
    ("corrected_rise", 8, 2.10),
    ("evidence_seam", 9, 0.80),
    ("solid_fifteen", 10, 0.80),
    ("projection_twenty_five", 11, 2.20),
    ("twice_projection_lands", 11, 6.00),
    ("projected_fibers_continue", 11, 7.93),
    ("countercase", 12, 1.00),
    ("ai_warning", 13, 0.50),
    ("flex_lattice", 14, 2.50),
    ("hazard_orbit", 15, 2.00),
    ("lattice_returns_bias", 15, 4.10),
    ("limits_card", 15, 6.00),
    ("general_context_icons", 15, 7.60),
    ("apparent_ceiling_moves", 16, 0.50),
    ("boundary_holds", 17, 0.50),
    ("final_ribbon", 18, 1.00),
    ("final_measurement_gap", 18, 3.50),
]
